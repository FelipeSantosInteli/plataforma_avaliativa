...
import {Box,Checkbox,FormControlLabel,Paper,Table,TableBody,
    TableCell,TableContainer,TableHead,TablePagination,TableRow,
    alpha,TableSortLabel,Toolbar,Typography,IconButton,Tooltip,Switch} from '@mui/material';
  ...
  var cols = ['col1','col2','col3','col4','col5','col6']
    ...
    function createData(name, col1, col2, col3, col4, col5, col6) {
      ...
      columnsName.map((Item) => {
        headCells.push({id:Item,disablePadding:false,label:Item})
      })
